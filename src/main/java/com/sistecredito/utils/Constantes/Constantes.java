package com.sistecredito.utils.Constantes;

public class Constantes {
    public static final String INTERACTION_AGREGARALCARRITO = "Clase interaction Agregar al carrito";
    public static final String INTERACTION_GUARDARDATOS = "Clase interaction Guardar datos";
